...
class JewelsWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (JewelsWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (JewelsWebStatus) -> Void) {
