...
enum JewelsWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: JewelsWebStatus) -> Bool {
        switch (self, other) {
...
extension JewelsWebStatus {
    static func == (lhs: JewelsWebStatus, rhs: JewelsWebStatus) -> Bool {
