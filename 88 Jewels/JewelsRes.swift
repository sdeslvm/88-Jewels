...
protocol WebLoadable: AnyObject {
    var state: JewelsWebStatus { get set }
...
final class JewelsWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: JewelsWebStatus = .standby
...
extension JewelsWebLoader: WKNavigationDelegate {
