...
struct JewelsGameInitialView: View {
    private var gameResourceURL: URL { URL(string: "https://fruitrushx.top/app")! }

    var body: some View {
        ZStack {
            Color(hex: "#000")
                .ignoresSafeArea()
            JewelsEntryScreen(loader: .init(resourceURL: gameResourceURL))
        }
    }
}

#Preview {
    JewelsGameInitialView()
}
