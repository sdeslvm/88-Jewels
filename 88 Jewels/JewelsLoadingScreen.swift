...
struct JewelsLoadingOverlay: View, ProgressDisplayable {
    let progress: Double
                ...
                VStack {
                    ...
                    VStack(spacing: 14) {
                        Text("Loading \(progressPercentage)%")
                            ...
                            .shadow(radius: 1)
                        JewelsProgressBar(value: progress)
...
struct JewelsBackground: View, BackgroundProviding {
...
#Preview("Vertical") {
    JewelsLoadingOverlay(progress: 0.2)
}
