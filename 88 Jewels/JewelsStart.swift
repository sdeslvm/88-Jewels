...
struct JewelsWebViewBox: UIViewRepresentable {
    // MARK: - Свойства

    @ObservedObject var loader: JewelsWebLoader

    // MARK: - Координатор

    func makeCoordinator() -> JewelsWebCoordinator {
        JewelsWebCoordinator { [weak loader] status in
